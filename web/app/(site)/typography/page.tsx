          ...
          <SiteRail>
            <SitePanel>
              ...
              <div className="mt-4 space-y-3 text-sm leading-7 text-[rgba(194,203,219,0.76)]">
                <p>The visual voice should feel calm, premium, and operationally honest.</p>
                <p>Heading scale carries hierarchy. Body copy carries explanation. Monospace carries tool truth.</p>
              </div>
            </SitePanel>
            ...
            <SitePanel>
              ...
              <div className="mt-4 grid gap-3">
                <div className="rounded-[1.5rem] border border-white/10 bg-black/25 px-4 py-4">
                  ...
                  <p className="mt-2 text-sm text-white">Hero statements, section openings, and important product framing.</p>
                </div>
                <div className="rounded-[1.5rem] border border-white/10 bg-black/25 px-4 py-4">
                  <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-zinc-500">
                    Monospace usage
                  </p>
                  <p className="mt-2 text-sm text-white">Commands, hosts, tokens, event output, and other operational literals only.</p>
                </div>
              </div>
            </SitePanel>
          </SiteRail>
